...
(function (factory) {
    ...
    register("AddService", "org.coodex.concrete.demo.api", { "add": function (x1, x2) {return invoke({"path": "/OrgCoodexConcreteDemoApiAddService/add","param": {"x1": x1, "x2": x2},"method": "POST", "dataType": "json" });}});
    ...
    register("MessageTriggerService", "org.coodex.concrete.demo.api.excepted", { "trigger": function (x) {return invoke({"path": "/OrgCoodexConcreteDemoApiExceptedMessageTriggerService/trigger","param": {"x": x},"method": "POST", "dataType": "json" });}});
    ...
    register("Polling", "org.coodex.concrete.jaxrs", { "polling": function (timeOut) {return invoke({"path": "/Concrete/polling","param": {"timeOut": timeOut},"method": "POST", "dataType": "json" });}});

    register("CarService", "org.coodex.concrete.demo.api", { "getCarById": function (id) {return invoke({"path": "/Cars/{id}","param": {"id": id},"method": "GET", "dataType": "json" });}, "warningExample": function () {return invoke({"path": "/Cars/warningExample","param": {},"method": "GET", "dataType": "json" });}, "getCarNumberById": function (id) {return invoke({"path": "/Cars/{id}/PlateCode","param": {"id": id},"method": "GET", "dataType": "text" });}});
